        ...
        if type_est == "lesson":
            ...
            self.lessons["lessons"][lesson]["average_test"] = reduce(lambda x, y: x + y,
                                                                     self.lessons["lessons"][lesson][
                                                                         "test_results"]) / len(
                self.lessons["lessons"][lesson]["test_results"])
...
if __name__ == '__main__':
    student_1 = Student("Alexey", "Kulikov", "Alexandrovich", Path('lessons.csv'))
    ...
    student_2 = Student("Petr", "Petrov", "Petrovich", Path('lessons.csv'))
